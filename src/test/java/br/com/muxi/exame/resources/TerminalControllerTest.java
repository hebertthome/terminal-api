...
public class TerminalControllerTest {
    ...
    public void postSuccessful() throws Exception {
        ...
        ResultActions result = this.mockMvc.perform(post(terminalPath).contentType("text/html").content(getValidJson()));
    ...
    public void postFailed_invalidInputValue() throws Exception {
        ...
        ResultActions result = this.mockMvc.perform(post(terminalPath).contentType("text/html").content("someone_value"));
    ...
    public void postFailed_invalidMediaType() throws Exception {
        ...
        ResultActions result = this.mockMvc.perform(post(terminalPath).contentType("application/json").content(getValidJson()));
    ...
    public void postFailed_errorOnSaveTerminal() throws Exception {
        ...
        this.mockMvc.perform(post(terminalPath).contentType("text/html").content(getValidJson()));
    }
    ...
    public void putSuccessful() throws Exception {
        ...
        ResultActions result = this.mockMvc.perform(put(terminalPath + 1).contentType("application/json").content(getValidJson()));
    ...
    public void putFailed_differentValues() throws Exception {
        ...
        ResultActions result = this.mockMvc.perform(put(terminalPath + 2).contentType("application/json").content(getValidJson()));
    ...
    public void putFailed_bodyError() throws Exception {
        ResultActions result = this.mockMvc.perform(put(terminalPath + 1).contentType("application/json").content("someone_value"));
    ...
    public void putFailed_errorOnSaveTerminal() throws Exception {
        ...
        this.mockMvc.perform(put(terminalPath + 1).contentType("application/json").content(getValidJson()));
    }
    ...
    private String getValidJson() {
        return "{\"logic\": 1, \"serial\": \"123\"," + "\"model\": \"PWWIN\",\"sam\": 0,\"ptid\": \"F04A2E4088B\","
                + "\"plat\": 4,\"version\": \"8.00b3\"," + "\"mxr\": 0,\"mxf\": 16777216,\"VERFM\": \"PWWIN\"}";
    }
